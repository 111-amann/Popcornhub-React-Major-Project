...
const Card = ({ data, personPara }) => {
  return (
      <div className="h-fit flex flex-wrap xl:gap-2 md:gap-3 gap-1 md:mt-5 mt-10 justify-center">
        {data.map((c, i) => (
          <Link key={i} className="flex flex-col items-center justify-center lg:mb-5 mb-2 p-1 xl:w-[15vw] xl:h-[26vw] lg:w-[15vw] lg:h-[27vw] md:w-[20vw] md:h-[35vw] w-[40vw] h-[70vw] bg-zinc-900 rounded-lg hover:bg-zinc-600 duration-300 shadow-[6px_13px_25px_2px_rgba(0,0,0,.5)] hover:shadow-[6px_13px_25px_2px_rgba(0,0,0,.2)] relative">
            <img
